...
<el-form ref="ruleFormRef" :rules="rules" :model="formStudent" label-width="80px">
  <el-row>
    ...
    <el-col :span="12">
      <el-form-item label="学生性别" prop="sex">
        <el-input v-model="formStudent.sex" placeholder="请输入学生性别"/>
      </el-form-item>
    </el-col>
    ...
    <el-col :span="12">
      <el-form-item label="QQ" prop="qq">
        <el-input v-model="formStudent.qq" placeholder="请输入QQ"/>
      </el-form-item>
    </el-col>
  ...
  <div class="dialog-button-wrap">
    ...
    <el-button @click="editStudent(ruleFormRef)" color="#178557" :loading="subLoading" type="success">保存</el-button>
  </div>
</template>
...
import {editStudentApi, gradeClassListApi} from "@/api/edu/student/student"
// 表单实例对象
...
const rules = reactive<FormRules>({
  ...
  stuno: [{ required: true,message: '学号不能为空',trigger: 'b;ur' }],
